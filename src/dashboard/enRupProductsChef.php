...
<head>
    ...
    <title>Chef - Produits En Rupture</title>
</head>
                ...
                <div class="navbar-nav w-100">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="./enRupProductsChef.php" class="dropdown-item active">En Rupture</a>
                        </div>
                    </div>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="bg-light  rounded p-4">
                    ...
                    <button class="btn btn-primary mx-auto my-3 d-block" onclick="expToExcel();">Exporter le tableau</button>
                </div>
            </div>
            <!--  Tableau des Produits Start -->
