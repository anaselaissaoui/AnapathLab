...
$queryProducts = "SELECT * FROM actions";
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="./history.php" class="nav-link nav-item active"><i class="bi bi-calendar2-week me-2"></i></i>Activités</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light  rounded p-4">
                    ...
                    <ul class="list-group list-group-light" id="actionsResult">
                        <?php include "./tableActions.php" ?>
                    </ul>
                </div>
            </div>
            <!--Table orders End -->
